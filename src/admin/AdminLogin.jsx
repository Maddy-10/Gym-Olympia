...
const AdminLogin = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    // If validation passes, continue with login logic (here, just navigation)
    ...
    return (
      <>
        <div className='flex h-screen'>
          <div className='w-3/4 md:w-1/2 xl:w-1/3 mx-auto my-auto text-white'>
            ...
            <form onSubmit={handleSubmit} className='border bg-white bg-opacity-10 text-white backdrop-filter backdrop-blur-sm border-white flex flex-col rounded-lg p-2'>
              ...
              <div className='w-3/4 flex flex-col mx-auto mt-2 py-3'>
                ...
                <input
                  type='text'
                  className='border-b-2 my-auto px-3 bg-transparent placeholder:text-white  mt-3'
